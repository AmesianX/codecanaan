...
<div class="main">
    ...
    <div class="slider-wrapper">
        <div id="da-slider" class="da-slider justfont">
            <div class="da-slide">
                <h2>動手，學會寫程式</h2>
                <p class="justfont-force">只有讓學習者自己動手練習撰寫程式，才能獲得最好的學習效果。「軟體設計學院」提供的豐富學習教材，提供比一般書籍題庫更大量的實作練習。</p>
                <%--<a href="#" class="da-link">連結</a>--%>
                <div class="da-img"><g:img dir="images" file="slide1.png" /></div>
            </div>
            <div class="da-slide">
                <h2>閱讀，享受高品質</h2>
                <p class="justfont-force">「軟體設計學院」比傳統 e-Learning 平台更重視教材閱讀品質，採用更完美的「信黑體」專業級中文網頁字型，並支援高解析度的平板閱讀器，提供媲美印刷等級的無障礙舒適閱讀。</p>
            ...
            <div class="widget stacked">
                ...
                <div class="widget-content">
                    ...
                    <ul class="features icons">
                        <li><i class="icon-ok icon-green"></i> 整合 Facebook 帳號登入</li>
                        <li><i class="icon-ok icon-green"></i> 完美結合 TQC+ 軟體設計領域認證題庫與教材</li>
                        <li><i class="icon-ok icon-green"></i> 大量強調手腦並用的程式碼實作練習題</li>
                        <li><i class="icon-ok icon-green"></i> 雲端教室數位學習服務，教學零負擔</li>
                        <li><i class="icon-ok icon-green"></i> 創新的網頁式整合開發環境，支援自動化編譯與測試</li>
                    </ul>
