...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <p class="larger-font textalign-center padding-around margin-around">
                您的帳號已經通過驗證。接下來，請為您的電腦安裝 Java 軟體！
            </p>
        </div>
    </div>
    ...
    <div class="clearlook-wrapper">
        <div class="row-fluid">
            <div class="span12 padding-around justfont">
                <div class="">
                ...
                <div class="hidden-if-java-installed">
        ...
        <div class="padding-around textalign-center">
            <g:link action="step3" class="btn btn-large btn-primary">
