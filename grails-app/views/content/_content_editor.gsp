...
<g:form controller="content" action="ajaxSave" method="post">
    ...
    <section class="hide advanced-region">
        <%--提示內容--%>
        <ul class="nav nav-tabs">
            <li class="active">
    ...
    <%--測驗題--%>
    <section class="${content?.type!=ContentType.QUIZ?'hide advanced-region':''}">
        <legend>測驗題專用欄位</legend>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <g:select name="quizType" from="${QuizType?.values()}" keys="${QuizType.values()*.name()}" required="" value="${content.quizType?.name()}" />
            </div>
        </div>
    ...
    <%--實作題--%>
    <section class="${content?.type!=ContentType.CODE?'hide advanced-region':''}">
        <legend>實作題專用欄位</legend>
        <div class="control-group">
            ...
            <div class="controls">
                <g:select name="sourceType" from="${SourceType?.values()}" keys="${SourceType.values()*.name()}" required="" value="${content.sourceType?.name()}" />
            </div>
        </div>
